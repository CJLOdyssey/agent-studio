    ...
    test: {
      ...
      coverage: {
        ...
        exclude: [
          ...
          'src/constants/**',
          'src/mocks/**',
          'src/components/agentstudio/workstation/workflow/**',
          'src/components/agentstudio/modals/**',
          'src/components/agentstudio/workstation/monitor/**',
          'src/components/agentstudio/workstation/logs/**',
        ],
      },
    },
  };
