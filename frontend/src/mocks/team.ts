...
export const MOCK_TEAMS: TeamEntry[] = [
  ...
  { id: 't5', name: '运维团队', description: '负责基础设施和CI/CD流水线', status: 'disabled', category: 'ops', createdAt: '2026-03-20', agents: [], memberCount: 0 },
  ...
  { id: 't8', name: '安全审计团队', description: '负责安全审计和合规检查', status: 'disabled', category: 'ops', createdAt: '2026-04-01', agents: [], memberCount: 0 },
