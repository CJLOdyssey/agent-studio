const langs: Record<string, [zh: string, en: string]> = {
  ...
  'skill.form_prompt': ['已选提示词', 'Prompt'],
  'skill.form_tools': ['已选工具', 'Tools'],
  'skill.form_mcp': ['已选MCP', 'MCP'],
  'skill.form_output_constraint': ['输出约束', 'Output Constraint'],
  'skill.form_model': ['模型', 'Model'],
  'skill.form_select_prompt': ['选择提示词', 'Select Prompt'],
  'skill.form_select_tools': ['选择工具', 'Select Tools'],
  'skill.form_select_mcp': ['选择MCP', 'Select MCPs'],
  'skill.form_select_constraint': ['选择约束', 'Select Constraint'],
