...
export default function CapabilityBadges({ capabilities }: { capabilities: string[] }) {
  const { t } = useTranslation();
  if (!capabilities || capabilities.length === 0) return <span className="text-[var(--color-text-muted)]">—</span>;
  return (
