    ...
    >
      ...
      <span
        className={
          ...
          before:content-[''] before:absolute before:rounded-full before:transition-all before:duration-200 before:bg-[var(--color-text-muted)] peer-checked:before:bg-[var(--da-text-on-accent)]
          ${size === 'sm'
