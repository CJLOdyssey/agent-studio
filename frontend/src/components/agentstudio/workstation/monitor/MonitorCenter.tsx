                    ...
                    >
                      <span
                        style={{
                          ...
                          height: 8,
                          borderRadius: '50%',
                          background: ACTIVITY_DOT[act.type] || ACTIVITY_DOT.info,
                          marginTop: 5,
                          flexShrink: 0,
                        }}
                      />
                  ...
                  {healthItems.map((h, i) => (
                    <div
                      ...
                      style={{
                        ...
                        padding: '10px 14px',
                        borderRadius: 8,
                        background: h.status === 'warning'
                          ? 'rgba(239,68,68,0.06)'
                          : 'var(--da-bg-hover)',
                      }}
                    >
                      <span style={{ fontSize: 13, color: 'var(--da-text-primary)', fontWeight: 500 }}>
                        {h.label}
                      </span>
                      <span
                        style={{
                          fontSize: 12,
                          fontWeight: 600,
                          color: h.status === 'normal' ? '#22c55e' : '#ef4444',
                          display: 'flex',
                          alignItems: 'center',
                          gap: 4,
                        }}
                      >
                        <span
                          style={{
                            ...
                            height: 6,
                            borderRadius: '50%',
                            background: h.status === 'normal' ? '#22c55e' : '#ef4444',
