const langs: Record<string, [zh: string, en: string]> = {
  ...
  'team.search_placeholder': ['搜索团队名称、负责人、描述...', 'Search name, leader, description...'],
  ...
  'team.form_leader': ['负责人', 'Leader'],
  'team.form_leader_placeholder': ['输入负责人姓名', 'Enter leader name'],
  'team.form_members': ['成员数', 'Members'],
