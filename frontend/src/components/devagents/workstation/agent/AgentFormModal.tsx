...
import type { ToolEntry } from '../tool/tool.types';
import type { MCPEntry } from '../mcp/mcp.types';
import type { SkillEntry } from '../skill/skill.types';
import { TEAM_OPTIONS, useModelOptions } from '../constants';
...
interface Props {
  ...
  onSave: () => void;
  onClose: () => void;
  availablePrompts: PromptEntry[];
  availableTools: ToolEntry[];
  availableMCPs: MCPEntry[];
