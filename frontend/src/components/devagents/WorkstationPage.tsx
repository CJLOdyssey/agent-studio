...
export default function WorkstationPage() {
  ...
  return (
    <div className="devagents-workstation-page">
      <div className="devagents-workstation-body">
        <div className="devagents-workstation-sidebar">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              className={`devagents-workstation-tab ${activeTab === tab.id ? 'active' : ''}`}
        ...
        <div className="devagents-workstation-content">
