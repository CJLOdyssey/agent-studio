...
> = {
  pm: {
    icon: ClipboardList,
    color: 'text-[var(--icon-planning)]',
    bg: 'bg-[var(--icon-planning)]/15',
    border: 'border-[var(--icon-planning)]/25',
    defaultName: '产品经理',
    defaultRole: '需求分析与产品规划',
  },
  architect: {
    icon: Layers,
    color: 'text-[var(--icon-planning)]',
    ...
    border: 'border-[var(--icon-planning)]/25',
    defaultName: '架构师',
    defaultRole: '系统架构与技术选型',
  },
  ui: {
    icon: Palette,
    color: 'text-[var(--icon-design)]',
    bg: 'bg-[var(--icon-design)]/15',
    border: 'border-[var(--icon-design)]/25',
    defaultName: 'UI 设计师',
    defaultRole: '界面与交互设计',
  },
  frontend: {
    icon: Code2,
    color: 'text-[var(--icon-dev-frontend)]',
    bg: 'bg-[var(--icon-dev-frontend)]/15',
    border: 'border-[var(--icon-dev-frontend)]/25',
    defaultName: '前端工程师',
    defaultRole: 'React/Vue 开发',
  },
  backend: {
    icon: Server,
    color: 'text-[var(--icon-dev-backend)]',
    bg: 'bg-[var(--icon-dev-backend)]/15',
    border: 'border-[var(--icon-dev-backend)]/25',
    defaultName: '后端工程师',
    defaultRole: 'API 与数据库设计',
  },
  qa: {
    icon: TestTube,
    color: 'text-[var(--icon-quality)]',
    bg: 'bg-[var(--icon-quality)]/15',
    border: 'border-[var(--icon-quality)]/25',
    defaultName: '测试工程师',
    defaultRole: '自动化与安全测试',
  },
  devops: {
    icon: Cloud,
    color: 'text-[var(--icon-ops)]',
    bg: 'bg-[var(--icon-ops)]/15',
    border: 'border-[var(--icon-ops)]/25',
    defaultName: 'DevOps',
    defaultRole: 'CI/CD 与部署运维',
  },
  fullstack: {
    icon: Zap,
    color: 'text-[var(--icon-dev-fullstack)]',
    bg: 'bg-[var(--icon-dev-fullstack)]/15',
    border: 'border-[var(--icon-dev-fullstack)]/25',
    defaultName: '全栈工程师',
    defaultRole: '跨领域快速开发',
  },
};
