...
export function typeLabel(a: { content_type?: string; filename: string }): string {
  if (a.content_type && TYPE_LABELS[a.content_type]) return TYPE_LABELS[a.content_type];
...
export function fileIconKey(a: { content_type?: string; filename: string }): IconKey {
