...
from backend.repository import create_prompt, delete_prompt, get_prompts_as_dicts, update_prompt
...
async def _snapshot_prompt(resource_id: str, session: AsyncSession | None = None) -> Any:
    ...
    try:
        ...
        async def _save(s: Any, rt: str, rid: str, **kw: Any) -> None:
            from backend.repository.prompts import get_prompt
...
async def remove_prompt(prompt_id: str) -> None:
    ...
    try:
        from backend.repository import get_prompts
