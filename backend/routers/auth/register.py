...
from backend.repository.auth import create_user, get_user_by_email, mark_user_verified
from backend.services.email_service import build_verification_email, send_email
