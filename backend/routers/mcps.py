...
from backend.repository import create_mcp, delete_mcp, get_mcps, get_mcps_as_dicts, update_mcp
...
async def _snapshot_mcp(resource_id: str, session: AsyncSession | None = None) -> Any:
    ...
    try:
        from backend.repository import get_mcps as _gmcps
...
async def test_mcp(mcp_id: str) -> Any:
    ...
    from backend.repository import get_mcps as _get_mcps
