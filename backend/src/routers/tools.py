...
async def _snapshot_tool(resource_id: str, session: AsyncSession | None = None) -> Any:
    ...
    try:
        ...
        async def _save(s: Any, rt: str, rid: str, **kw: Any) -> None:
            from repository.tools import get_tool as repo_get_tool
