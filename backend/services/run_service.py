...
from backend.broker import buffer_run_messages
...
class RunService:
    ...
    async def create_run(
        ...
        """
        from backend.repository import create_run as db_create_run
        ...
        try:
            if team_id:
                from backend.repository.workflows import get_workflow_config_by_team

                workflow = await get_workflow_config_by_team(team_id)
                if workflow:
                    from backend.tasks import _run_agent_pipeline
    ...
    async def continue_run(
        ...
        async def _run_pipeline() -> Any:
            try:
                from backend.tasks import _complete_pipeline
