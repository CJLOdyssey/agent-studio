...
boilerplate with a lazy ``from backend.core.infra.database import get_session_factory``
that violated the three-layer strictness rule.

Usage::

    from backend.repository.snapshot_helper import create_snapshot
...
from backend.repository.versions import create_version
