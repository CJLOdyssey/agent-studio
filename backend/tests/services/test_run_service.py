...
class TestRunService:
    ...
    async def test_create_run_no_api_key_raises(self):
        ...
        with (
            ...
            patch("services.run_helpers.create_session") as mock_create_sess,
            patch("services.run_helpers.get_api_key_for_use") as mock_get_key,
            patch("services.run_helpers.get_api_key_for_model") as mock_get_model,
            patch("services.run_helpers.get_default_api_key") as mock_get_default,
        ):
    ...
    async def test_create_run_with_key_id_success(self):
        ...
        with (
            ...
            patch("services.run_helpers.get_session") as mock_get_sess,
            patch("services.run_service.get_session") as mock_get_sess2,
            patch("services.run_service.update_session_title"),
            patch("services.run_service.db_create_run") as mock_db_create_run,
        ):
            mock_load.return_value.model = "gpt-4"
            mock_sess = MagicMock()
            ...
            mock_get_sess2.return_value = mock_sess
    ...
    async def test_create_run_with_existing_session(self):
        ...
        with (
            ...
            patch("services.run_helpers.get_session") as mock_get_sess,
            patch("services.run_service.get_session") as mock_get_sess2,
            patch("services.run_helpers.get_api_key_for_use"),
            patch("services.run_helpers.get_api_key_for_model") as mock_get_model,
            patch("services.run_helpers.get_default_api_key") as mock_get_default,
            patch("services.run_service.save_message", new_callable=AsyncMock),
            ...
            mock_get_sess2.return_value = existing
            mock_get_model.return_value = None
    ...
    async def test_create_run_session_not_found_creates_new(self):
        ...
        with (
            ...
            mock_get_sess2.return_value = None
            new_sess = MagicMock()
