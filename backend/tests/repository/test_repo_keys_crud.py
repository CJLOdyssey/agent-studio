...
async def test_get_embedding_config_fallback_keeps_base_url(db_engine, monkeypatch):
    ...
    import repository.keys_config as keys_config
    import repository.keys_crud as keys_crud

    # EMBEDDING_MODEL 由 keys_config 引用（get_embedding_config 所在模块）
    monkeypatch.setattr(keys_config, "EMBEDDING_MODEL", "env-tuned-model")
