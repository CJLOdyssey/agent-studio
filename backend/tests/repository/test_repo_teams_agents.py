...
async def test_get_team_found():
    from repository.teams import create_team, get_team
...
async def test_get_teams_filtered_by_owner():
    from repository.teams import get_teams
...
async def test_create_team_duplicate_name():
    from repository.teams import create_team
...
async def test_update_team_partial():
    from repository.teams import create_team, update_team
...
async def test_update_team_not_found():
    from repository.teams import update_team
...
async def test_delete_team():
    from repository.teams import create_team, delete_team
...
async def test_add_team_member():
    from repository.teams import add_team_member, create_team
...
async def test_add_team_member_team_not_found():
    from repository.teams import add_team_member
...
async def test_remove_team_member():
    from repository.teams import add_team_member, create_team, remove_team_member
...
async def test_reorder_team_members():
    from core.infra.database import TeamAgentDB
    from repository.teams import add_team_member, create_team, reorder_team_members
...
async def test_link_agent_config():
    from repository.agents import create_agent_config
    from repository.teams import add_team_member, create_team, link_agent_config
...
async def test_link_agent_config_member_not_found():
    from repository.teams import link_agent_config
...
async def test_get_agent_configs():
    from repository.agents import create_agent_config, get_agent_configs
...
async def test_get_active_agent_configs():
    from repository.agents import create_agent_config, get_active_agent_configs
...
async def test_get_agent_config_by_role():
    from repository.agents import create_agent_config, get_agent_config_by_role
...
async def test_get_agent_config_by_role_not_found():
    from repository.agents import get_agent_config_by_role
...
async def test_get_agent_config():
    from repository.agents import create_agent_config, get_agent_config
...
async def test_get_agent_config_count():
    from repository.agents import create_agent_config, get_agent_config_count
...
async def test_update_agent_config():
    from repository.agents import create_agent_config, update_agent_config
...
async def test_update_agent_config_not_found():
    from repository.agents import update_agent_config
...
async def test_delete_agent_config():
    from repository.agents import create_agent_config, delete_agent_config
...
async def test_delete_agent_config_not_found():
    from repository.agents import delete_agent_config
