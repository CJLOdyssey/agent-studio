...
from virtual_team.core.database import KeyUsageLog, UserApiKey, get_session_factory
from virtual_team.core.key_vault import decrypt_api_key, encrypt_api_key, mask_api_key
...
async def get_embedding_api_key() -> str | None:
    ...
    from virtual_team.core.database import UserApiKey
    from virtual_team.core.key_vault import decrypt_api_key
