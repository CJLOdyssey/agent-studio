...
""",
    ...
    {
        "type": "docs",
        "keywords": ["文档", "documentation", "readme"],
        "name": "documentation-standards",
        "description": "文档编写规范，生成清晰、完整的项目文档",
...
""",
    ...
    {
        "type": "performance",
        "keywords": ["性能", "performance", "优化", "optimization"],
...
""",
    ...
    {
        "type": "refactor",
        "keywords": ["重构", "refactor", "代码质量"],
        "name": "refactoring-guidelines",
        "description": "代码重构规范，安全、渐进式地改进代码质量",
        "category": "code-quality",
        "content": """---
name: refactoring-guidelines
description: 代码重构规范，安全、渐进式地改进代码质量
...
""",
    ...
    {
        "type": "git",
        "keywords": ["git", "提交", "commit", "版本控制"],
        "name": "git-workflow",
        "description": "Git 工作流规范，提交、分支、合并的最佳实践",
        "category": "workflow",
        "content": """---
name: git-workflow
description: Git 工作流规范，提交、分支、合并的最佳实践
...
""",
    ...
    {
        "type": "database",
        "keywords": ["数据库", "database", "sql", "迁移"],
        "name": "database-standards",
        "description": "数据库设计和操作规范",
        "category": "database",
        "content": """---
name: database-standards
description: 数据库设计和操作规范
...
""",
    ...
    {
        "type": "deploy",
        "keywords": ["部署", "deploy", "ci/cd", "docker"],
        "name": "deployment-checklist",
        "description": "部署流程规范，确保安全、可靠地发布",
        "category": "devops",
        "content": """---
name: deployment-checklist
description: 部署流程规范，确保安全、可靠地发布
...
def _build_custom_skill(skill_id: str, description: str) -> dict[str, Any]:
...
class SkillGenerator(BaseGenerator):
    ...
    def generate(self, request: GenerateRequest) -> GenerateResponse:
        skill_id = f"skill_{hashlib.md5(request.description.encode()).hexdigest()[:8]}"  # nosec
        ...
        custom = _build_custom_skill(skill_id, request.description)
        return GenerateResponse(
            id=skill_id,
            name=custom["name"],
    ...
    def supported_keywords(self) -> list[str]:
        return [kw for t in SKILL_TEMPLATES for kw in t["keywords"]]

    def _match_template(self, description: str) -> dict[str, Any] | None:
        desc_lower = description.lower()
        for template in SKILL_TEMPLATES:
            if any(kw.lower() in desc_lower for kw in template["keywords"]):
                return template
        return None
