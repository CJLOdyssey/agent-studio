...
class TestCreateToken:
    def test_returns_valid_jwt_string(self):
        from virtual_team.auth_jwt import create_token
    ...
    def test_token_contains_user_id(self):
        from virtual_team.auth_jwt import create_token, decode_jwt
...
class TestDecodeJWT:
    ...
    def test_base64url_decode_pads_correctly(self):
        from virtual_team.auth_jwt import _base64url_decode
