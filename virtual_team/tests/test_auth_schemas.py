"""Unit tests for virtual_team/routers/auth/schemas.py (Pydantic request/response models)."""
...
class TestAuthSchemas:
    def test_login_request_defaults(self):
        from virtual_team.routers.auth.schemas import LoginRequest
    ...
    def test_register_request_valid(self):
        from virtual_team.routers.auth.schemas import RegisterRequest
    ...
    def test_email_validation_rejects_invalid(self):
        from virtual_team.routers.auth.schemas import SendRegisterCodeRequest

        with pytest.raises(ValidationError):
            SendRegisterCodeRequest(email="not-an-email")

    def test_auth_response_default_token_type(self):
        from virtual_team.routers.auth.schemas import AuthResponse, UserResponse
    ...
    def test_user_response_optional_username(self):
        from virtual_team.routers.auth.schemas import UserResponse
    ...
    def test_merge_request(self):
        from virtual_team.routers.auth.schemas import MergeRequest

        req = MergeRequest(guest_id="guest-uuid")
        assert req.guest_id == "guest-uuid"

    def test_verify_request(self):
        from virtual_team.routers.auth.schemas import VerifyRequest
    ...
    def test_message_response(self):
        from virtual_team.routers.auth.schemas import MessageResponse

        resp = MessageResponse(message="ok")
        assert resp.message == "ok"

    def test_email_hint_response(self):
        from virtual_team.routers.auth.schemas import EmailHintResponse
    ...
    def test_auth_config_response(self):
        from virtual_team.routers.auth.schemas import AuthConfigResponse
...
class TestAuthHelpers:
    def test_generate_code_returns_six_digits(self):
        from virtual_team.routers.auth.schemas import _generate_code
    ...
    def test_mask_email_typical(self):
        from virtual_team.routers.auth.schemas import _mask_email
    ...
    def test_client_ip_with_forwarded(self):
        from virtual_team.routers.auth.schemas import _client_ip
...
# ─────────────────────────────────────────────────────────────────────
# 7. virtual_team/services/run_service.py — RunService
# ─────────────────────────────────────────────────────────────────────
