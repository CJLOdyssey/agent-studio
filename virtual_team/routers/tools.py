...
'''
        ...
        kw in desc_lower for kw in ["执行", "exec", "运行", "run", "命令", "command", "shell"]
    ):
        name = "run_command"
        desc = "执行Shell命令"
...
# ── CRUD routes ──────────────────────────────────────────────────────────────
from virtual_team.repository import create_tool as repo_create_tool  # noqa: E402
from virtual_team.repository import delete_tool, update_tool  # noqa: E402
